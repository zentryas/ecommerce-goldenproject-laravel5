            ...
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Sudah dibayar</li>
                    </ol>
                </div>
                <h4 class="page-title">Sudah dibayar</h4>
                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Pelanggan sudah bayar & harap segera mengemas paket!</td>
                                        ...
                                        <td>
                                            ...
                                            @if(empty($data->nomor_resi))
                                                <a href="/admin/transaksi/kirim-resi/{{ $data->id }}" class="btn btn-danger btn-sm">Kirim Resi</a>
                                            @endif                                            
                                        </td>
                                    </tr>
                                </div>
